...
EPISODES = 20005
MAX_STEPS = 5000  # longer episodes for more walking practice
...
SIGMA_MIN = 0.05
REWARD_SCALE = 1.0
MODEL_PATH = "ddpg_humanoid_finalv7.pth"
...
for episode in range(EPISODES):
    ...
    for step in range(MAX_STEPS):
        ...
        # Simple reward shaping (original approach)
    ...
    # Save best modeland avg_rewards[-1] >= 4000
